...
public class myOrderDaishuo extends Fragment implements internet_landing.re_jk {
	View v;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (v == null) {
			v = inflater.inflate(R.layout.myorderdaishuo, container, false);
			x.view().inject(this, v);
			handler = new MyHandler(myOrderDaishuo.this);
	...
	private void xutils_getorderall(final int page) {
		...
		String url = "https://app.juandie.com/api_mobile/user.php?act=order_list&order_status=1&page="+page;
	...
	public static class MyHandler extends Handler {
		...
		public MyHandler(myOrderDaishuo activity) {
			referenceObj = new WeakReference<myOrderDaishuo>(activity);
		}

		@Override
		public void handleMessage(Message msg) {
			final myOrderDaishuo activity = referenceObj.get();
			switch (msg.what) {
			case 0x01:
