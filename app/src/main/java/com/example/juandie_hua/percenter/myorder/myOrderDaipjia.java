...
public class myOrderDaipjia extends Fragment implements re_jk {
    View v;
    myorder_adapter ada;
    List<myorder_adaData> list;

    @ViewInject(R.id.morderdpj_listv)
    ListView listv_v;

    @ViewInject(R.id.morderdpj_nogoods)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (v == null) {
            v = inflater.inflate(R.layout.myorderdaipjia, container, false);
            x.view().inject(this, v);
            handler = new MyHandler(myOrderDaipjia.this);
    ...
    private void setviewhw() {
        ...
        setviewhw_lin(layout_nogoods, w, (int) (w * 180 / 375.0), 0,
                (int) (w * 100 / 375.0), 0, 0);
    }
    ...
    private void xutils_getorderall(final int page) {
        ...
        String url = "https://app.juandie.com/api_mobile/user.php?act=order_list&order_status=2&page=" + page;
    ...
    public static class MyHandler extends Handler {
        WeakReference<myOrderDaipjia> referenceObj;

        public MyHandler(myOrderDaipjia activity) {
            referenceObj = new WeakReference<myOrderDaipjia>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final myOrderDaipjia activity = referenceObj.get();
            switch (msg.what) {
                case 0x01:
